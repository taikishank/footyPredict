...
func (f *fakeFetcher) FetchUpcomingBetween(ctx context.Context, start, end time.Time) ([]sportmonks.Fixture, error) {
	f.calls++
	if f.err != nil {
		return nil, f.err
	}
...
func (s *fakeStore) UpsertUpcomingFixtures(ctx context.Context, fixtures []ParsedFixture) (int, error) {
